...
QT_MOC_LITERAL(1, 11, 20), // "setRadioButtonEscena"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 20), // "setRadioButtonCamara"
QT_MOC_LITERAL(4, 54, 13) // "tractarCamara"

    },
    "MyGLWidget\0setRadioButtonEscena\0\0"
    "setRadioButtonCamara\0tractarCamara"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setRadioButtonEscena(); break;
        case 1: _t->setRadioButtonCamara(); break;
        case 2: _t->tractarCamara(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::setRadioButtonEscena)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyGLWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::setRadioButtonCamara)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::setRadioButtonEscena()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void MyGLWidget::setRadioButtonCamara()
{
