...
QT_MOC_LITERAL(1, 11, 8), // "enviaFov"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 12) // "designerZoom"

    },
    "MyGLWidget\0enviaFov\0\0designerZoom"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->enviaFov((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->designerZoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::enviaFov)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::enviaFov(int _t1)
{
