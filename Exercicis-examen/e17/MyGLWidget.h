...
class MyGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core 
{
  ...
  signals:
    void setCamaraPatrisio();
    
  public slots:
    void tractarCamara();
    void tractarColorR(int);
    void tractarColorG(int);
    void tractarColorB(int);
  ...
  private:
    ...
    // attribute locations
    GLuint vertexLoc, normalLoc, matambLoc, matdiffLoc, matspecLoc, matshinLoc, test;
    ...
    glm::vec3 centrePatr, OBS, VRP, up, diff = glm::vec3(0.8,0,0.8);
